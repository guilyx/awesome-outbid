...
| [whopaidmost.com](https://whopaidmost.com) | businesses | A business edition with a public money trail: every payment is listed on a /payments ledger and a /stats page, a Hall of Kings records each #1 and how long it reigned, and a monthly board restarts the race every month alongside the all-time one. Entries carry a country flag and can be filtered by country; $1 gets a spot and paying more than #1 takes it. |
